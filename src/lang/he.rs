...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_rustdesk_password_tip", "אמת סיסמת AMA Connect"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "אנא שדרג את AMA Connect Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "אנא שדרג את לקוח AMA Connect לגרסה {} או חדשה יותר בצד המרוחק!"),
