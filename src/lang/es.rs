...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red AMA Connect en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que AMA Connect no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar AMA Connect a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a AMA Connect de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a AMA Connect de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que AMA Connect use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [AMA Connect Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep AMA Connect background service", "Dejar AMA Connect como Servicio en 2do plano"),
        ...
        ("Show AMA Connect", "Mostrar AMA Connect"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a AMA Connect permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a AMA Connect permisos de \"Grabar Audio\"."),
        ...
        ("verify_ama-connect_password_tip", "Verificar la contraseña de AMA Connect"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses AMA Connect e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_ama-connect_server_pro_to_{}_tip", "¡Por favor, actualiza AMA Connect Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que AMA Connect no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de AMA Connect"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de AMA Connect de fondo"),
        ...
        ("About AMA Connect", "Acerca de AMA Connect"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_ama-connect_client_to_{}_tip", "Por favor, actualiza el cliente AMA Connect a la versión {} o superior en el lado remoto"),
