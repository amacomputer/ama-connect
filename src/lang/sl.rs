...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem AMA Connect..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, AMA Connect v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate AMA Connectu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate AMA Connectu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno AMA Connectu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »AMA Connect Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep AMA Connect background service", "Ohrani AMA Connectovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije AMA Connect, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "AMA Connect potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "AMA Connect potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_ama-connect_password_tip", "Preveri geslo za AMA Connect"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite AMA Connect, prekinite klic in program zaprite."),
        ("scam_text2", "AMA Connect omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_ama-connect_server_pro_to_{}_tip", "Prosimo, nadgradite AMA Connect Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo AMA Connect"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno AMA Connecta odprto"),
        ...
        ("floating_window_tip", "Pomaga pri AMA Connect storitvi v ozadju"),
        ...
        ("About AMA Connect", "O AMA Connectu"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_ama-connect_client_to_{}_tip", "Prosimo, nadgradite AMA Connect odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
