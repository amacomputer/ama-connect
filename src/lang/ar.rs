...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة AMA Connect..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. AMA Connect قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت AMA Connect في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح AMA Connect اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح AMA Connect اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ AMA Connect باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [AMA Connect Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep AMA Connect background service", "ابق خدمة AMA Connect تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق AMA Connect, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show AMA Connect", "عرض AMA Connect"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من AMA Connect اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح AMA Connect اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في AMA Connect الذي يعمل."),
        ...
        ("verify_ama-connect_password_tip", "تحقق من كلمة مرور AMA Connect"),
        ...
        ("upgrade_ama-connect_server_pro_to_{}_tip", "ترقية خادم AMA Connect Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع AMA Connect"),
        ...
        ("About AMA Connect", "حول AMA Connect"),
        ...
        ("upgrade_remote_ama-connect_client_to_{}_tip", "ترقية عميل AMA Connect البعيد إلى {}"),
