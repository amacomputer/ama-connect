...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "AMA Connecti võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa AMA Connect mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et AMA Connect oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb AMA Connectile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb AMA Connectile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma AMA Connectile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [AMA Connect Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep AMA Connect background service", "Säilita AMA Connecti taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele AMA Connecti rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show AMA Connect", "Kuva AMA Connect"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma AMA Connectile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma AMA Connectile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud AMA Connecti kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_ama-connect_password_tip", "Kinnita AMA Connecti parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul AMA Connecti kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_ama-connect_server_pro_to_{}_tip", "Palun täienda AMA Connect Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib AMA Connectil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb AMA Connectil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui AMA Connecti aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada AMA Connecti taustateenust."),
        ...
        ("About AMA Connect", "AMA Connecti teave"),
        ...
        ("upgrade_remote_ama-connect_client_to_{}_tip", "Täiendage AMA Connecti klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
