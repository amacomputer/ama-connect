...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke AMA Connect..."),
        ...
        ("install_tip", "Karena UAC, AMA Connect tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal AMA Connect ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk AMA Connect."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk AMA Connect."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd AMA Connect untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input AMA Connect]."),
        ...
        ("Language", "Bahasa"),
        ("Keep AMA Connect background service", "Pertahankan AMA Connect berjalan pada service background"),
        ...
        ("Show AMA Connect", "Tampilkan AMA Connect"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada AMA Connect"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada AMA Connect"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC AMA Connect yang sedang berjalan"),
        ...
        ("verify_ama-connect_password_tip", "Verifikasi Kata Sandi AMA Connect"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan AMA Connect, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_ama-connect_server_pro_to_{}_tip", "Silahkan perbarui AMA Connect Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah AMA Connect berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh AMA Connect"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela AMA Connect sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service AMA Connect agar tetap aktif"),
        ...
        ("About AMA Connect", "Tentang AMA Connect"),
        ...
        ("upgrade_remote_ama-connect_client_to_{}_tip", "Silahkan perbarui aplikasi AMA Connect ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
