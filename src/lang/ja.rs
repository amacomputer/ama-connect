...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_rustdesk_password_tip", "AMA Connect のパスワードを確認する"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "AMA Connect Server Pro をバージョン {} 以上にアップグレードしてください！"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "リモート側の AMA Connect クライアントをバージョン {} 以上にアップグレードしてください！"),
