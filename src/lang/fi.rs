...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään AMA Connect verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa AMA Connect ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi AMA Connectin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava AMA Connectille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava AMA Connectille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten AMA Connect daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota AMA Connectille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli AMA Connect ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "AMA Connect palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa AMA Connectin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "AMA Connect palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep AMA Connect background service", "Pidä AMA Connectin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista AMA Connectin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show AMA Connect", "Näytä AMA Connect"),
        ...
        ("verify_ama-connect_password_tip", "Vahvista AMA Connect salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "AMA Connect ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_ama-connect_server_pro_to_{}_tip", "Päivitä AMA Connect Server Pro versioon {} jatkaaksesi."),
        ...
        ("About AMA Connect", "Tietoa AMA Connectistä"),
        ...
        ("upgrade_remote_ama-connect_client_to_{}_tip", "Päivitä etä-AMA Connect-asiakasversioon {} yhteensopivuuden takaamiseksi"),
