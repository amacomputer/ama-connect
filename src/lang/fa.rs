...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_rustdesk_password_tip", "رمز عبور AMA Connect را تأیید کنید"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "را به نسخه {} یا جدیدتر ارتقا دهید AMA Connect Server Pro لظفا"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "لطفاً AMA Connect را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
