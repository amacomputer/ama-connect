...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete AMA Connect..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), AMA Connect diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare AMA Connect a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a AMA Connect su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a AMA Connect su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a AMA Connect de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada AMA Connect]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep AMA Connect background service", "Mantene su servìtziu de AMA Connect in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione AMA Connect, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("Show AMA Connect", "Mustra AMA Connect"),
        ("This PC", "Custu PC"),
        ("or", "O"),
        ("Elevate", "Cresche"),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a AMA Connect sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a AMA Connect."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de AMA Connect."),
        ...
        ("verify_ama-connect_password_tip", "Cunfirma sa crae de AMA Connect"),
        ...
        ("Exit", "Essi dae AMA Connect"),
        ("Open", "Aberi AMA Connect"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare AMA Connect e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_ama-connect_server_pro_to_{}_tip", "Atualiza AMA Connect Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de AMA Connect comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae AMA Connect"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana AMA Connect est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de AMA Connect"),
        ...
        ("About AMA Connect", "Informatziones subra de AMA Connect"),
        ...
        ("upgrade_remote_ama-connect_client_to_{}_tip", "Atualiza su cliente AMA Connect remotu a sa versione {} o prus noa!"),
