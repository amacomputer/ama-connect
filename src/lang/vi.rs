...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới AMA Connect..."),
        ...
        ("install_tip", "Do cơ chế UAC, AMA Connect có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt AMA Connect vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho AMA Connect."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho AMA Connect."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [AMA Connect Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep AMA Connect background service", "Giữ dịch vụ AMA Connect chạy nền"),
        ...
        ("Show AMA Connect", "Hiện AMA Connect"),
        ...
        ("verify_ama-connect_password_tip", "Xác thực mật khẩu AMA Connect"),
        ...
        ("scam_text2", "Chỉ sử dụng AMA Connect với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_ama-connect_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ AMA Connect mở"),
        ...
        ("floating_window_tip", "Giữ AMA Connect trên cùng"),
        ...
        ("About AMA Connect", "Về AMA Connect"),
        ...
        ("upgrade_remote_ama-connect_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
