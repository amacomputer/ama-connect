...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_rustdesk_password_tip", "Verifica la contrasenya del AMA Connect"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Actualitzeu el AMA Connect Server Pro a la versió {} o superior!"),
