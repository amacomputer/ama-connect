...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "AMA Connect może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować AMA Connect w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić AMA Connect przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić AMA Connect na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [AMA Connect Input]."),
        ...
        ("Language", "Język"),
        ("Keep AMA Connect background service", "Zachowaj usługę AMA Connect w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji AMA Connect, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show AMA Connect", "Pokaż AMA Connect"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji AMA Connect uprawnień do \"Urządzeń Wejściowych\"."),
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać AMA Connect uprawnienia do \"Nagrań audio\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z AMA Connect w Twojej sieci."),
        ...
        ("verify_ama-connect_password_tip", "Weryfikuj hasło AMA Connect"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu AMA Connect - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_ama-connect_server_pro_to_{}_tip", "Proszę zaktualizować AMA Connect Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu AMA Connect po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez AMA Connect"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno AMA Connect jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę AMA Connect w tle"),
        ...
        ("upgrade_remote_ama-connect_client_to_{}_tip", "Proszę zaktualizować zdalny klient AMA Connect do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie AMA Connect weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, AMA Connect pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, AMA Connect nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS AMA Connect nie obsługuje tej funkcji."),
