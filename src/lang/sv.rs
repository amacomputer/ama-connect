...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till AMA Connect..."),
        ...
        ("install_tip", "På grund av UAC, kan inte AMA Connect fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera AMA Connect på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge AMA Connect \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge AMA Connect \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [AMA Connect Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep AMA Connect background service", "Behåll AMA Connect i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa AMA Connect programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show AMA Connect", "Visa AMA Connect"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
