...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_rustdesk_password_tip", "Επιβεβαιώστε τον κωδικό του AMA Connect"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε το AMA Connect Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Αναβαθμίστε τον πελάτη AMA Connect στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
