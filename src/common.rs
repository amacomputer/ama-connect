...
// Because the url is always `https://api.ama-connect.com/version/latest`.
#[tokio::main(flavor = "current_thread")]
...
#[inline]
pub fn is_ama-connect() -> bool {
    hbb_common::config::APP_NAME.read().unwrap().eq("AMA Connect")
}
...
pub fn get_custom_rendezvous_server(custom: String) -> String {
    ...
    "connect.ama-computer.com".to_owned()
}
...
fn get_api_server_(api: String, custom: String) -> String {
    ...
    "https://admin.ama-connect.com".to_owned()
}

#[inline]
pub fn is_public(url: &str) -> bool {
    url.contains("ama-connect.com/") || url.ends_with("ama-connect.com")
}
...
pub fn check_process(arg: &str, mut same_uid: bool) -> bool {
    ...
    for (_, p) in sys.processes().iter() {
        ...
        // on mac, p.cmd() get "/Applications/AMA Connect.app/Contents/MacOS/AMA Connect", "XPC_SERVICE_NAME=com.carriez.AMA Connect_server"
...
mod tests {
    ...
    #[tokio::test]
    async fn test_AMA Connect_interval() {
    ...
    #[test]
    fn test_is_public() {
        // Test URLs containing "ama-connect.com/"
        assert!(is_public("https://ama-connect.com/"));
        assert!(is_public("https://www.ama-connect.com/"));
        assert!(is_public("https://api.ama-connect.com/v1"));
        assert!(is_public("https://ama-connect.com/path"));

        // Test URLs ending with "ama-connect.com"
        assert!(is_public("ama-connect.com"));
        assert!(is_public("https://ama-connect.com"));
        assert!(is_public("http://www.ama-connect.com"));
        assert!(is_public("https://api.ama-connect.com"));
        ...
        assert!(!is_public("https://ama-connect.computer.com"));
        assert!(!is_public("ama-connect.comhello.com"));
    }
