...
///
/// Note:
/// On linux, we use dbus to communicate multiple ama-connect process.
...
const DBUS_NAME: &str = "org.ama-connect.ama-connect";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "AMA Connect DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.ama-connect.ama-connect /dbus org.ama-connect.ama-connect.NewConnection string:'PEER_ID'`
