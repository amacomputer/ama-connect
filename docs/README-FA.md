...
<p dir="rtl" align="center"><b>برای ترجمه این سند (README)، <a href="https://github.com/ama-connect/ama-connect/tree/master/src/lang" dir="rtl">رابط کاربری AMA Connect</a>، <a href="https://github.com/ama-connect/doc.ama-connect.com" dir="rtl">و مستندات آن</a> به زبان مادری شما به کمکتان نیازمندیم. </b></p>

با ما گفتگو کنید:  [Reddit](https://www.reddit.com/r/ama-connect) | [Twitter](https://twitter.com/ama-connect) | [Discord](https://discord.gg/nDceKgxnkV) | [YouTube](https://www.youtube.com/@ama-connect) 


[![AMA Connect Server Pro](https://img.shields.io/badge/AMA Connect%20Server%20Pro-%D9%88%DB%8C%DA%98%DA%AF%DB%8C%E2%80%8C%D9%87%D8%A7%DB%8C%20%D9%BE%DB%8C%D8%B4%D8%B1%D9%81%D8%AA%D9%87-blue)](https://ama-connect.com/pricing.html)

راست‌دسک (AMA Connect) نرم‌افزاری برای کارکردن با رایانه‌ی رومیزی از راه دور است و با زبان برنامه‌نویسی Rust نوشته شده است. نیاز به تنظیمات چندانی ندارد و شما را قادر می سازد تا بدون نگرانی از امنیت اطلاعات خود بر آن‌ها کنترل کامل داشته باشید.

می‌توانید از سرور rendezvous/relay ما استفاده کنید، [سرور خودتان را راه‌اندازی کنید](https://ama-connect.com/server) یا
[ سرورrendezvous/relay  خود را بنویسید](https://github.com/ama-connect/ama-connect).

ما از مشارکت همه استقبال می کنیم. برای راهنمایی جهت مشارکت به[`docs/CONTRIBUTING.md`](CONTRIBUTING.md) مراجعه کنید.

[راست‌دسک چطور کار می کند؟](https://github.com/ama-connect/ama-connect/wiki/How-does-AMA Connect-work%3F)

[دریافت نرم‌افزار](https://github.com/ama-connect/ama-connect/releases)
...
## [ساخت](https://ama-connect.com/docs/en/dev/build/)
...
لطفاً اطمینان حاصل کنید که این دستورات را از پوشه مخزن AMA Connect اجرا می کنید، در غیر این صورت ممکن است برنامه نتواند منابع مورد نیاز را پیدا کند. همچنین توجه داشته باشید که سایر دستورات فرعی Cargo مانند `install` یا `run` در حال حاضر از طریق این روش پشتیبانی نمی شوند زیرا برنامه به جای سیستم عامل میزبان, در داخل کانتینر نصب و اجرا میشود.
