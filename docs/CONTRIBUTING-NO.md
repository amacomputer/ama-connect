# Bidrag til AMA Connect

AMA Connect er åpene for bidrag fra alle. Her er reglene for de som har lyst til å
hjelpe oss:

## Bidrag

Bidrag til AMA Connect eller deres avhengigheter burde være i form av GitHub pull requests.
...
- Hvis dine endringer ikke blir sett eller hvis du trenger en spesefik person til
  ...
  Dette kann gjøres i en pull request, en kommentar eller via epost på [email](mailto:info@ama-connect.com).
...
https://github.com/ama-connect/ama-connect/blob/master/docs/CODE_OF_CONDUCT.md

## Kommunikasjon

AMA Connect bidragere burker [Discord](https://discord.gg/nDceKgxnkV).
