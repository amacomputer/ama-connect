<p align="center">
  <img src="../res/logo-header.svg" alt="AMA Connect – vaše vzdálená plocha"><br>
  ...
  <b>Potřebujeme Vaši pomoc s překladem tohoto README, <a href="https://github.com/ama-connect/ama-connect/tree/master/src/lang">uživatelského rozhraní aplikace AMA Connect</a> a <a href="https://github.com/ama-connect/doc.ama-connect.com">dokumentace k ní</a> do vašeho jazyka</b>
</p>

Popovídejte si s námi: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/ama-connect) | [Reddit](https://www.reddit.com/r/ama-connect) | [YouTube](https://www.youtube.com/@ama-connect)


[![AMA Connect Server Pro](https://img.shields.io/badge/AMA Connect%20Server%20Pro-Pokro%C4%8Dil%C3%A9%20Funkce-blue)](https://ama-connect.com/pricing.html)

Zase další software pro přístup k ploše na dálku, naprogramovaný v jazyce Rust. Funguje hned tak, jak je – není třeba žádného nastavování. Svá data máte ve svých rukách, bez obav o zabezpečení. Je možné používat námi poskytovaný propojovací/předávací (relay) server, [vytvořit si svůj vlastní](https://ama-connect.com/server), nebo [si dokonce svůj vlastní naprogramovat](https://github.com/ama-connect/ama-connect-server-demo), budete-li chtít.

Projekt AMA Connect vítá přiložení ruky k dílu od každého. Jak začít se dozvíte z [`docs/CONTRIBUTING.md`](CONTRIBUTING.md).

[**Jak AMA Connect funguje?**](https://github.com/ama-connect/ama-connect/wiki/How-does-AMA Connect-work%3F)

[**STAHOVÁNÍ ZKOMPILOVANÝCH APLIKACÍ**](https://github.com/ama-connect/ama-connect/releases)
...
## [Sestavení ze zdrojových kódů](https://ama-connect.com/docs/en/dev/build/)
...
Ujistěte se, že tyto příkazy spouštíte z kořenového adresáře AMA Connect, jinak aplikace nemusí být schopná nalézt potřebné prostředky (resources). Také si všimněte, že ostatní dílčí príkazy nástroje cargo, jako třeba `install` nebo `run` zatím nejsou prostřednictvím této metody podporovány, protože by vedly k instalaci či spuštění program uvnitř kontejneru namísto přímo v systému.

## Struktura souborů

- **[libs/hbb_common](https://github.com/ama-connect/ama-connect/tree/master/libs/hbb_common)**: kodek videa, nastavení, obalovaní tcp/udp, vyrovnávací paměť protokolu, funkce souborového systému pro přenos souborů a pár dalších podpůrných funkcí
- **[libs/scrap](https://github.com/ama-connect/ama-connect/tree/master/libs/scrap)**: zachytávání obsahu obrazovky
- **[libs/enigo](https://github.com/ama-connect/ama-connect/tree/master/libs/enigo)**: ovládání klávesnice/myši pro jednotlivé platformy
- **[src/ui](https://github.com/ama-connect/ama-connect/tree/master/src/ui)**: grafické uživatelské rozhraní
- **[src/server](https://github.com/ama-connect/ama-connect/tree/master/src/server)**: služby pro zvuk/schránku/zadávání/video a síťová spojení
- **[src/client.rs](https://github.com/ama-connect/ama-connect/tree/master/src/client.rs)**: spouští připojení k protějšku
- **[src/rendezvous_mediator.rs](https://github.com/ama-connect/ama-connect/tree/master/src/rendezvous_mediator.rs)**: komunikace s [ama-connect-server](https://github.com/ama-connect/ama-connect-server), očekávání vzdálených příméhých („proděrováváním“ TCP) nebo předávaných (relay) spojení
- **[src/platform](https://github.com/ama-connect/ama-connect/tree/master/src/platform)**: zdrojové kódy, specifické pro jednotlivé platformy
- **[flutter](https://github.com/ama-connect/ama-connect/tree/master/flutter)**: zdrojové kódy pro použití s aplikačním rámcem (framework) Flutter pro mobilní platformy
- **[flutter/web/js](https://github.com/ama-connect/ama-connect/tree/master/flutter/web/js)**: Javascript pro Flutter webový klient
